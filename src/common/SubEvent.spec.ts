...
// describe('SubEvent', () => {
//   it('count 1000 for dispatch 1000 on checker 1', () => {
//     const testId = '1'
...
//   it('count 1000 for dispatch 1000 on 2 checkers', () => {
//     const testId = '2'
//     const subEvent = new SubEvent<callback>()
...
//   it('count 1000 for dispatch 1000 on 1st checkers and 0 in second when unregister', () => {
//     const testId = '2'
//     const subEvent = new SubEvent<callback>()
